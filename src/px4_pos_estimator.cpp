...
*/
    // 【订阅】optitrack估计位置
    ros::Subscriber optitrack_sub = nh.subscribe<geometry_msgs::PoseStamped>("/vrpn_client_node/UAV_6_4/pose", 1000, optitrack_cb);
    ...
    //ros::Timer,ros中的定时器
    //设置频率为20HZ
    ros::Timer pose_pub_timer = nh.createTimer(ros::Duration(1.0/50.0),pose_pub_timer_cb);
